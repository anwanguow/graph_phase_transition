...
for i in range(init_number):
    ...
    name_0 = "simulation/md_" + str(i) + "/answer/dop_bt_0_50.npy"
    name_1 = "simulation/md_" + str(i) + "/answer/dop_bt_50_100.npy"
    name_2 = "simulation/md_" + str(i) + "/answer/dop_bt_100_150.npy"
    name_3 = "simulation/md_" + str(i) + "/answer/dop_bt_150_200.npy"
    name_4 = "simulation/md_" + str(i) + "/answer/dop_bt_200_250.npy"
    name_5 = "simulation/md_" + str(i) + "/answer/dop_bt_250_300.npy"
    name_6 = "simulation/md_" + str(i) + "/answer/dop_bt_300_350.npy"
    name_7 = "simulation/md_" + str(i) + "/answer/dop_bt_350_400.npy"
    name_8 = "simulation/md_" + str(i) + "/answer/dop_bt_400_450.npy"
    name_9 = "simulation/md_" + str(i) + "/answer/dop_bt_450_500.npy"
...
plt.legend([f0,f1,f2,f3,f4,f5,f6,f7,f8,f9], ['$(n_0,n_1)=(0,500)$', '$(n_1,n_2)=(500,1000)$','$(n_2,n_3)=(1000,1500)$','$(n_3,n_4)=(1500,2000)$','$(n_4,n_5)=(2000,2500)$','$(n_5,n_6)=(2500,3000)$','$(n_6,n_7)=(3000,3500)$','$(n_7,n_8)=(3500,4000)$','$(n_8,n_9)=(4000,4500)$','$(n_9,n_{10})=(4500,5000)$'], loc='best')   
...
plt.savefig("dop_10000.png", dpi = 300)
plt.show()
