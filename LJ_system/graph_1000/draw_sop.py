...
for i in range(init_number):
    ...
    name_0 = "simulation/md_" + str(i) + "/answer/dist_s_0.npy"
    name_1 = "simulation/md_" + str(i) + "/answer/dist_s_100.npy"
    name_2 = "simulation/md_" + str(i) + "/answer/dist_s_200.npy"
    name_3 = "simulation/md_" + str(i) + "/answer/dist_s_300.npy"
    name_4 = "simulation/md_" + str(i) + "/answer/dist_s_400.npy"
    name_5 = "simulation/md_" + str(i) + "/answer/dist_s_500.npy"
    name_6 = "simulation/md_" + str(i) + "/answer/dist_s_600.npy"
    name_7 = "simulation/md_" + str(i) + "/answer/dist_s_700.npy"
    name_8 = "simulation/md_" + str(i) + "/answer/dist_s_800.npy"
    name_9 = "simulation/md_" + str(i) + "/answer/dist_s_900.npy"
    name_10 = "simulation/md_" + str(i) + "/answer/dist_s_1000.npy"
...
plt.legend([f0,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10], ['$n_0=0$', '$n_1=100$', '$n_2=200$', '$n_3=300$', '$n_4=400$', '$n_5=500$', '$n_6=600$', '$n_7=700$', '$n_8=800$', '$n_9=900$', '$n_{10}=1000$'], loc='best')

plt.xlim(0.01,2)
plt.ylim(0,1.63)
plt.xticks([0.01,0.75,2])

plt.axvline(x = 0.75, color = 'coral', label = '', alpha = 0.5, linestyle = 'dashdot')

plt.title("Ensemble number: " + str(int(init_number)))
plt.xlabel("Temperature ($\epsilon/k_B$)")
plt.ylabel("Structural order parameters")
plt.savefig("/Users/dmr/Desktop/fig_many/sop_" + str(int(init_number)) + ".png", dpi = 300)
plt.show()
